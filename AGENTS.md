...
- Shared engineering practices (for example `git mv` for tracked renames): [docs/dev-practices.md](docs/dev-practices.md).
...
| [docs/dev-practices.md](docs/dev-practices.md)                           | Shared engineering practices (file moves/renames with `git mv`, and further practices as they are added)                                                              | When moving or renaming tracked files; whenever adding or looking up repo-wide contributor/agent practices                                                                                    |
...
| [docs/specs/paper-archiving.md](docs/specs/paper-archiving.md)           | Paper archiving (step 5): create-or-reuse `Paper` by `(source_id, source_uid)`; DOI required (uppercase public id); fail-soft skips; no EFetch | When implementing or changing paper create/reuse from candidates, `Paper` fields, or archiving identity rules |
