...
| [docs/specs/3-references-selection.md](docs/specs/3-references-selection.md) | References selection phase landing: header/stepper and link to Show references | When implementing or changing the References selection landing |
| [docs/specs/3.1-show-references.md](docs/specs/3.1-show-references.md) | Show references (3.1): page and chrome; list from the database not built yet | When implementing or changing the Show references page or Reference list UX |
| [docs/specs/3.2-add-reference.md](docs/specs/3.2-add-reference.md) | Add reference (3.2): stub page; Papers search + add one / add all not built | When implementing or changing Add reference attach UX |
