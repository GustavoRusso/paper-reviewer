...
- `/docs/specs` — Feature and workflow specs. Workflow-step specs use a zero-padded step number prefix matching [README.md](README.md) (e.g. `06-complete-papers-data.md` for step 6). Paper-source-specific docs live under `docs/specs/paper-sources/` (no step number).
...
| [docs/specs/06-complete-papers-data.md](docs/specs/06-complete-papers-data.md) | Complete papers data (step 6): idempotent Prefect `inform_paper_from_source` (EFetch); durable `source_informed_at`; dedicated progress UI | When implementing or changing source-inform, `Paper` EFetch field groups, or the Complete papers data progress page |
