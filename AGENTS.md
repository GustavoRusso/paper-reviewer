...
| [docs/specs/2.2-paper-ingestion.md](docs/specs/2.2-paper-ingestion.md) | Paper Ingestion (phase 2 step 2, docs-only group): index of archive / fulfill / brief / evaluation / indexing leaf steps; no Streamlit page in v1 | When looking up the Paper Ingestion step group or its substep list |
