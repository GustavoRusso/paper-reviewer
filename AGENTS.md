...
| [docs/specs/2.2.3-generate-paper-brief.md](docs/specs/2.2.3-generate-paper-brief.md) | Generate paper brief (2.2.3): global 1:1 `PaperBrief`; gated on full text `succeeded`; topic-agnostic content; page enqueues `create_paper_brief` only. Brief section list and LLM prompt: [src/paper_reviewer/topic_scope/generate_paper_brief/paper_brief_template.md](src/paper_reviewer/topic_scope/generate_paper_brief/paper_brief_template.md) | When implementing or changing `PaperBrief`, brief Prefect jobs, the brief template, or the Generate paper brief progress page |
...
| [docs/specs/4-topic-brief.md](docs/specs/4-topic-brief.md) | Topic brief phase: Generate/Regenerate (blocked if zero briefed References); Prefect `create_topic_brief`; `TopicBrief`; `[n]` citations + `citation_description`; quality index deferred. Prompt: [src/paper_reviewer/topic_scope/topic_brief/topic_brief_template.md](src/paper_reviewer/topic_scope/topic_brief/topic_brief_template.md) | When implementing or changing Topic brief drafting, `TopicBrief`, the Prefect job, or the topic-brief template |
