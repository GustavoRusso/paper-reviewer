...
| [docs/specs/1.2-topic-analysis.md](docs/specs/1.2-topic-analysis.md) | Topic analysis (phase 1 step 2): scispaCy NER → persist `TopicFacet` rows on `TopicScope`; Topic scope hub (statement, facets, independent phase links) | When implementing or changing topic analysis, facet persistence, the analysis page, or the Topic scope hub |
