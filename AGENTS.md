...
| [docs/specs/2.2.4-paper-indexing.md](docs/specs/2.2.4-paper-indexing.md) | Paper indexing (2.2.4): generated `keywords_tsv` + GIN from `source_record.indexing.keywords`; no Streamlit page in v1 | When implementing or changing the local Papers search document or GIN index |
...
| [docs/specs/4-topic-brief.md](docs/specs/4-topic-brief.md) | Topic brief phase: Generate/Regenerate (blocked if zero briefed References); Prefect `create_topic_brief`; `TopicBrief`; `[n]` citations + `citation_description`; quality index deferred. Prompt: [src/paper_reviewer/topic_brief_generation/topic_brief/topic_brief_template.md](src/paper_reviewer/topic_brief_generation/topic_brief/topic_brief_template.md) | When implementing or changing Topic brief drafting, `TopicBrief`, the Prefect job, or the topic-brief template |
