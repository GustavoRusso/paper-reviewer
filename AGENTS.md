...
| [docs/specs/3.2-add-reference.md](docs/specs/3.2-add-reference.md) | Add reference (3.2): auto-runs Papers search and shows hits; Add / Add all not built | When implementing or changing Add reference search results or attach UX |
