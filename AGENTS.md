...
| [docs/specs/05-paper-archiving.md](docs/specs/05-paper-archiving.md)           | Paper archiving: dedicated Streamlit page auto-runs create-or-reuse `Paper` from related-paper search `candidates`; DOI uppercase; fail-soft skips; no EFetch | When implementing or changing paper create/reuse from candidates, `Paper` fields, archiving UI, or identity rules |
