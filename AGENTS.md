...
- `/docs/specs` — Feature and workflow specs. Phase 1 (Topic definition) uses a dotted `P.S-name.md` prefix matching [README.md](README.md) (e.g. `1.1-topic-intake.md`, `1.2-topic-analysis.md`). Phase landings use `2-external-sources-ingestion.md`, `3-paper-search.md`, `4-topic-brief.md`. Phase 2 uses `2.1-search-external-sources.md`, docs-only group `2.2-paper-ingestion.md`, and leaf specs `2.2.1`–`2.2.4`. External-source-specific docs live under `docs/specs/external-sources/` (no step number).
...
| [docs/specs/2.2.4-paper-indexing.md](docs/specs/2.2.4-paper-indexing.md) | Paper indexing (2.2.4): stub; index ingested papers for local Paper search (not built) | When implementing or changing paper indexing for local search |
