...
| [docs/project-structure.md](docs/project-structure.md)                   | Repo layout, deploy vs local-only paths, `pyproject.toml` placement, package module map (incl. `ingest` / `search`) | When adding packages/modules, deciding what Docker images copy, or where to put ORM/UI/ingest/search/flow code                                                                                              |
