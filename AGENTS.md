...
| [docs/specs/07-generate-paper-brief.md](docs/specs/07-generate-paper-brief.md) | Generate paper brief (step 7): global 1:1 `PaperBrief`; gated on full text `succeeded`; topic-agnostic content; page 7 enqueues `create_paper_brief` only | When implementing or changing `PaperBrief`, brief Prefect jobs, or the Generate paper brief progress page |
