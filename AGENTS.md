...
| [docs/specs/retrieval-triage.md](docs/specs/retrieval-triage.md)         | Retrieval triage (step 4): review gate for search candidates; v1 pass-through with dedicated Streamlit confirm page before Paper archiving | When implementing or changing triage confirm API, retained-set handoff, or the triage UI page |
