...
| [docs/specs/4-topic-brief.md](docs/specs/4-topic-brief.md) | Topic brief phase: Generate/Regenerate button, Prefect `create_topic_brief`, `TopicBrief` entity, progress UI. Section list and LLM prompt: [src/paper_reviewer/topic_brief_generation/topic_brief/topic_brief_template.md](src/paper_reviewer/topic_brief_generation/topic_brief/topic_brief_template.md) | When implementing or changing Topic brief drafting, `TopicBrief`, the Prefect job, or the topic-brief template |
