...
- **Paper brief evaluation** — Paper Ingestion substep that scores a succeeded **paper brief** with an LLM-as-judge against the paper’s full text. Spec: [docs/specs/2.2.4-paper-brief-evaluation.md](docs/specs/2.2.4-paper-brief-evaluation.md) (docs-only; not implemented).
