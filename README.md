...
## LLM Zoomcamp evaluation map

Paper Reviewer is an end-to-end LLM application: it retrieves local ingested papers, then drafts a cited topic brief from selected References. If you review this project against the [LLM Zoomcamp project evaluation criteria](https://github.com/DataTalksClub/llm-zoomcamp/blob/main/project.md), use the table below to find where each criterion is defined in this repo. A link names the owning spec or doc; it does not claim full credit for that criterion.
...
| Retrieval evaluation                 | [docs/specs/papers-search.md](docs/specs/papers-search.md)                                                                                                                             |                                                                                                                                                                                                                                        |
| LLM evaluation                       | [docs/specs/2.2.4-paper-brief-evaluation.md](docs/specs/2.2.4-paper-brief-evaluation.md), [docs/specs/paper-brief-evaluation-offline.md](docs/specs/paper-brief-evaluation-offline.md) | Run an online evaluation on each Paper brief generated. Run an offline evaluation using in-app G-Eval + offline judge runs                                                                                                             |
...
| Monitoring                           | [docs/local-development.md](docs/local-development.md)                                                                                                                                 | Prefect UI / worker only; no user-feedback spec; no 5-chart monitoring spec                                                                                                                                                            |
...
| Deployment to the cloud (bonus)      | —                                                                                                                                                                                      | Not specified                                                                                                                                                                                                                          |
| Extra bonus                          | —                                                                                                                                                                                      | Optional extras (e.g. offline notebooks, scispaCy) live in their own docs                                                                                                                                                              |
