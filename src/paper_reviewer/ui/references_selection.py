"""Paper search phase landing Streamlit page (v1 shell)."""
...
NOT_BUILT_CAPTION = "Search of locally ingested papers is not built yet."
...
def render_paper_search() -> None:
    """Render the Paper search landing for the Topic scope in the URL."""
