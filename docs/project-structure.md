...
| --- | --- | --- |
| Topic brief generation steps | `paper_reviewer.topic_brief_generation.<step>` | Step behavior for the README workflow (intake, analysis, related-paper search, triage, paper archiving, paper briefs generation, topic brief). Specs: [specs/02-topic-analysis.md](specs/02-topic-analysis.md), [specs/03-related-paper-search.md](specs/03-related-paper-search.md), [specs/04-retrieval-triage.md](specs/04-retrieval-triage.md), [specs/05-paper-archiving.md](specs/05-paper-archiving.md), [specs/06-paper-briefs-generation.md](specs/06-paper-briefs-generation.md). |
