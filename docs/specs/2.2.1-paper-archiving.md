...
- Optional pure helpers (skip reason → display label, paper caption lines, aspect/brief progress labels, `may_submit_regenerate_paper`) unit-tested without Streamlit if extracted from render.
