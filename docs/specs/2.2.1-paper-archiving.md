...
5. **Topic brief generation** uses those briefs.
...
| --- | --- |
| Map candidates → create-or-reuse / skip `Paper` | `paper_reviewer.topic_scope.paper_archiving` (`archive_papers`) |
...
| Pydantic `Paper`, `PaperArchivingResult`, skip/error types | `paper_reviewer.schemas.topic_scope` |
