...
5. **Exit** — After facets exist: `st.page_link` to **Topic scope** (pass `topic_scope_key`). Do **not** `st.switch_page` to the hub. Do **not** call `search_related_papers`. Do **not** link directly to a phase landing from this page.
