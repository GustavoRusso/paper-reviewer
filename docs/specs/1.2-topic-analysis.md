...
- Dedicated **Topic scope hub** page: statement + facets + links to External sources ingestion, Paper search, and Topic brief.
...
4. When facets exist, render in this order:
   ...
   3. Three phase **page_links** (navigate only; pass `topic_scope_key`): **External sources ingestion**, **Paper search**, **Topic brief**.
5. The user may open any phase without completing the others. Do not add gates between those links.

Phase landing contracts: [External sources ingestion](2-external-sources-ingestion.md), [Paper search](3-paper-search.md), [Topic brief](4-topic-brief.md).
