...
flowchart TB
  ...
  referencesSelection[Show references]
...
3. The **hub** shows the statement and facets, then the user chooses a later phase. Search external sources is the first ingest step when the user opens [External sources ingestion](2-external-sources-ingestion.md), not an automatic next step after analysis. References selection has no landing: the hub opens [Show references](3.1-show-references.md).
...
4. When facets exist, render in this order:
   ...
   3. Three phase **page_links** (navigate only; pass `topic_scope_key`): **External sources ingestion**, **References selection** (opens [Show references](3.1-show-references.md)), **Topic brief generation**.
