...
4. When facets exist, render in this order:
   ...
   3. Three phase **page_links** (navigate only; pass `topic_scope_key`): **External sources ingestion**, **References selection**, **Topic brief**.
5. The user may open any phase without completing the others. Do not add gates between those links.

Phase landing contracts: [External sources ingestion](2-external-sources-ingestion.md), [References selection](3-references-selection.md), [Topic brief](4-topic-brief.md).
...
- Implement Add reference attach or Topic brief drafting on the hub (those stay on their phase pages — [Add reference](3.2-add-reference.md), [Topic brief](4-topic-brief.md)).
