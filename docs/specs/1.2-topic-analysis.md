...
3. The **hub** shows the statement and facets, then the user chooses a later phase. Search external sources is the first ingest step when the user opens [Paper ingestion](2-paper-ingestion.md), not an automatic next step after analysis.
