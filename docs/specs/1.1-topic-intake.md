...
Topic analysis, facet rows, the Topic scope hub, and later phases are out of scope here — see [Topic analysis](1.2-topic-analysis.md) and [Topic scope hub](topic-scope-hub.md).
...
- The Topic scope hub and phase landings ([Topic scope hub](topic-scope-hub.md)).
...
3. After analysis, the user opens the Topic scope hub and chooses a later phase — [Topic scope hub](topic-scope-hub.md). Phases are independent — [README.md](../../README.md).
