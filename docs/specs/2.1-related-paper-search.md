...
In this step, the system searches registered **paper sources** for related papers and produces a global list of **paper candidates** for [Retrieval triage](04-retrieval-triage.md) (and then [Paper archiving](05-paper-archiving.md)).
...
| Term | Meaning |
| --- | --- |
| **Related-paper search** | Paper ingestion step 2.1: search paper sources with topic facets and produce `PaperCandidate`s for Retrieval triage. |
...
Facet generation and persistence stay in [Topic analysis](1.2-topic-analysis.md). Retrieval triage, Paper archiving, and later ingest steps are out of scope here.
...
| Key | Type | Role |
| --- | --- | --- |
| `related_paper_search_result` | `RelatedPaperSearchResult` | Cached search **output** for triage handoff. Not a source of facets. |
